    ...
    <div className='flex flex-col bg-white'>
      <div className='flex flex-col lg:flex-row items-center max-w-[60%] justify-evenly mx-auto -mb-20'>
        ...
        <div>
          <div className='flex gap-4 items-center'>
            <img className='w-[40px] h-fit self-start mt-6' src='//d2r9epyceweg5n.cloudfront.net/assets/insti/img/home/why_nube/icons/layouts.jpg' alt='tienda' />
            <div>
          ...
          <div className='flex gap-4 items-center'>
            <img className='w-[40px] h-fit self-start mt-6' src='//d2r9epyceweg5n.cloudfront.net/assets/insti/img/home/why_nube/icons/apps.jpg' alt='negocio' />
            <div>
          ...
          <div className='flex gap-4 items-center'>
            <img className='w-[40px] h-fit self-start mt-6' src='//d2r9epyceweg5n.cloudfront.net/assets/insti/img/home/why_nube/icons/ecosystem.jpg' alt='red' />
            <div>
      ...
      <div className='flex flex-col lg:flex-row-reverse items-center max-w-[80%] justify-evenly lg:mx-auto py-20'>
        <div className='flex lg:max-w-[45%] justify-center items-center mx-auto box-border'>
          <img className='lg:p-20 max-w-lg box-border' src={image2} alt="envio" />
        </div>
        <div className='flex flex-col justify-end ml-20'>
          <div className='flex gap-4 items-center'>
            <img className='w-[40px] h-fit self-start mt-6' src='//d2r9epyceweg5n.cloudfront.net/assets/insti/img/business/blocks/shipping.png' alt='envio' />
            <div>
          ...
          <div className='flex gap-4 items-center'>
            <img className='w-[40px] h-fit self-start mt-6' src='//d2r9epyceweg5n.cloudfront.net/assets/insti/img/business/blocks/payments.png' alt='pago' />
            <div>
